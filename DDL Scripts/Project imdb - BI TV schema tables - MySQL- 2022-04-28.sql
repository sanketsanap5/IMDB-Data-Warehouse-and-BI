...
CREATE TABLE dim_imdb_name_basics (
                  name_sk int NOT NULL AUTO_INCREMENT,
	nconst varchar(10) NOT NULL,
...
CREATE TABLE dim_imdb_titleType  (
	titleType_sk int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE dim_imdb_title_basics (
                 title_sk int NOT NULL AUTO_INCREMENT,
	tconst varchar(10) NOT NULL,
...
CREATE TABLE dim_imdb_primaryProfession   (
	primaryProfession_sk int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE dim_imdb_name_basics_knownForTitles (
	knownForTitles_sk int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE dim_imdb_name_basics_primaryProfession (
	name_basics_primaryProfession_sk int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE dim_imdb_genres   (
	genres_sk int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE dim_imdb_title_basics_genres (
	titles_genres_sk int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE dim_imdb_title_crew_directors (
	directors_sk int NOT NULL AUTO_INCREMENT,
                  title_sk int,
                  name_sk int,
...
CREATE TABLE dim_imdb_title_crew_writers (
	writers_sk int NOT NULL AUTO_INCREMENT,
                 title_sk int,
                 name_sk int,
...
CREATE TABLE dim_imdb_title_episode (
	title_episode_sk int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE dim_imdb_job_category   (
	job_category_sk int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE dim_imdb_title_principals (
	title_principals_sk int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE fct_imdb_title_ratings (
	title_ratings_sk int NOT NULL AUTO_INCREMENT,
