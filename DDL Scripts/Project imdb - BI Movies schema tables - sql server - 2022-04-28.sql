...
-- use imdb_bi_movies, imdb_bi_people, imdb_bi_tv
-- ;
...
CREATE TABLE BI_list_titles  (
	...
	DI_JobID varchar(20) NOT NULL,
	DI_Create_DT datetime DEFAULT getdate() NOT NULL,
	PRIMARY KEY CLUSTERED  (title_sk)
);
...
CREATE TABLE BI_list_BRG_titles_names  (
	...
	DI_JobID varchar(20) NOT NULL,
	DI_Create_DT datetime DEFAULT getdate() NOT NULL,
	PRIMARY KEY CLUSTERED  (name_sk,title_sk)
);
-- CREATE NONCLUSTERED INDEX CIX_BI_list_BRG_titles_names ON BI_list_BRG_titles_names  (nconst,tconst);

-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

-- imdb_dev.dbo.DI_stg_file_ingest definition

-- DROP TABLE DI_stg_file_ingest;
...
-- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- imdb_dev.dbo.dim_imdb_Franchise definition

-- DROP TABLE dim_imdb_Franchise;

CREATE TABLE dim_imdb_Franchise (
	Franchise_sk int NOT NULL IDENTITY(1,1),
	Franchise_Name varchar(80) NULL,
	Franchise_Source varchar(80) NULL,
	Franchise_imdb bit DEFAULT ((0)) NULL,
	Franchise_TheNumber bit DEFAULT ((0)) NULL,
	DI_JobID varchar(20) NOT NULL,
	DI_Create_DT datetime DEFAULT (getdate()) NOT NULL,
...
-- for individual movies box office performance
